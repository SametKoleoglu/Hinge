  ...
  public: {
    Tables: {
      ...
      profile_answers: {
        ...
        Relationships: [
          {
            foreignKeyName: "profile_amns_profile_id_fkey"
            columns: ["profile_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "profile_amns_prompt_id_fkey"
            columns: ["prompt_id"]
            isOneToOne: false
      ...
      profile_ethnicity_preferences: {
        ...
        Relationships: [
          {
            foreignKeyName: "profile_ethnicitiy_preferences_ethnicity_id_fkey"
            columns: ["ethnicity_id"]
            isOneToOne: false
            referencedRelation: "ethnicities"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "profile_ethnicitiy_preferences_profile_id_fkey"
            columns: ["profile_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
